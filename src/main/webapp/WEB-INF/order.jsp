        ...
        <div id="myFogSVGsideview" class="modalone">
            ...
            <div class="modal-contentone">
                ...
                <text x="<%out.print(lengthline + 15);%>" y="<%out.print(height / 2);%>"
                      ...
                      <br/>
                      <h3>Styklist</h3>
        <button id="myBtnitemlist">Åben styklist</button>              
        <div id="myFogSVGitemlist" class="modalitemlist">
            <div class="modal-contentitemlist">
                <span class="closeitemlist">&times;</span>
                <table border = "1" class="ordretableitemlist">
                    <tr>
                        <th><p>Navn</p></th>
